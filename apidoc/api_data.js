define({ "api": [
  {
    ...
    "version": "0.0.0",
    "filename": "app/controllers/ShopController.java",
    "groupTitle": "ADMIN-SHOP"
  },
  {
    "type": "GET",
    "url": "/v1/user/ad_list/?pageType=&sourceType=",
    "title": "01广告列表",
    "name": "listAd",
    "group": "AD",
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "adOwnerList",
            "description": "<p>广告主列表</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "app/controllers/AdController.java",
    "groupTitle": "AD"
  },
  {
    "type": "POST",
    "url": "/v1/user/post_top/",
    "title": "09置顶/取消置顶贴子",
    "name": "placePostTop",
    "group": "Admin-Post",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "placeTop",
            "description": "<p>true置顶 false取消置顶</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/v1/user/categories_posts/",
    "title": "02帖子分类列表带贴子",
    "name": "listPostCategoriesWithPosts",
    "group": "Post",
    "success": {
      "fields": {
        "Success 200": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "orderType",
            "description": "<p>orderType 1最新发表 2最新回复 3最多回复</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/v1/user/reply_list/?id=&page=",
    "title": "10评论列表",
    "name": "replyList",
    "group": "Post",
    "success": {
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "app/controllers/ServiceController.java",
    "groupTitle": "SERVICE"
  },
  {
    "type": "POST",
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "app/controllers/ShowCaseController.java",
    "groupTitle": "SHOW-CASE"
  },
  {
    "type": "POST",
    "url": "/v1/user/show_case/",
    "title": "05删除案例图片",
    "name": "deleteShowcase",
    "group": "SHOW-CASE",
    "parameter": {
  ...
  {
    "type": "GET",
    "url": "/v1/user/show_case_list/?shopId=&page=&title=",
    "title": "01案例图片",
    "name": "listShowCase",
    "group": "SHOW-CASE",
    "success": {
  ...
  {
    "type": "GET",
    "url": "/v1/user/shop_list/?page=&name=",
    "title": "01店铺列表",
    "name": "listShop",
    "group": "Shop",
    "success": {
        ...
        "Error 40003": [
          {
            ...
            "optional": false,
            "field": "code",
            "description": "<p>40003 上传失败</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "app/controllers/AliyunUploadController.java",
    "groupTitle": "System"
  },
  {
    "type": "post",
    "url": "/v1/user/apply_auth/",
    "title": "19提交认证审核",
    "name": "applyAuth",
    "group": "User",
    "parameter": {

...
public class AlipayNotify extends BaseController {
     ...
     * @return 验证结果
     */
    public boolean verify(Map<String, String> params, boolean needOnlineVerify) {
        ...
        if (needOnlineVerify) {
            if (params.get("notify_id") != null) {
                ...
                if (responseTxt.equals("true")) verified = true;
            }
        } else verified = true;
        if (isSign && verified) {
            return true;
    ...
    private boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        Map<String, String> sParaNew = AlipayCore.paraFilter(Params, true);
        //获取待签名字符串
        String preSignStr = AlipayCore.createLinkString(sParaNew);
        //获得签名验证结果
        boolean isSign = false;
        if (AlipayConfig.sign_type.equals("RSA")) {
            isSign = RSA.verify(preSignStr, sign, bizUtils.getAlipayAliPublicKey(), AlipayConfig.input_charset);
        }
        return isSign;
    }
    ...
    private String verifyResponse(String notify_id) {
        ...
        String partner = bizUtils.getAlipayPartnerNo();

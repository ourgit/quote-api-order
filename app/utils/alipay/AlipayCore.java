...
public class AlipayCore {
     ...
     */
    public static Map<String, String> paraFilter(Map<String, String> sArray, boolean needPassSignType) {
        ...
        for (String key : sArray.keySet()) {
            ...
            if (needPassSignType && key.equalsIgnoreCase("sign_type")) continue;

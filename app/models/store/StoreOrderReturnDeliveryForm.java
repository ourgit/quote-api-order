 ...
 */
@Entity
@Table(name = "v1_store_order_return_delivery_form")
public class StoreOrderReturnDeliveryForm extends Model {
    ...
    public static Finder<Long, StoreOrderReturnDeliveryForm> find = new Finder<>(StoreOrderReturnDeliveryForm.class);

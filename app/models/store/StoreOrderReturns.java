...
public class StoreOrderReturns extends Model {
    ...
    @Transient
    public List<StoreOrderReturnsDetail> orderReturnsDetailList = new ArrayList<>();

    public static Finder<Long, StoreOrderReturns> find = new Finder<>(StoreOrderReturns.class);

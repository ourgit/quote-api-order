 ...
 */
@Entity
@Table(name = "v1_order_return_refund_form")
public class OrderReturnRefundForm extends Model {
    ...
    public static Finder<Long, OrderReturnRefundForm> find = new Finder<>(OrderReturnRefundForm.class);

 ...
 */
@Entity
@Table(name = "v1_order_returns_img")
public class OrderReturnsImage extends Model {
    ...
    public static Finder<Long, OrderReturnsImage> find = new Finder<>(OrderReturnsImage.class);

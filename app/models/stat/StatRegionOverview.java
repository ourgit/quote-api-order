 ...
 */
@Entity
@Table(name = "v1_stat_overview_region")
public class StatRegionOverview extends Model {
    ...
    public static Finder<Long, StatRegionOverview> find = new Finder<>(StatRegionOverview.class);

 ...
 */
@Entity
@Table(name = "v1_stat_day_region")
public class StatDayRegionOverview extends Model {
    ...
    public static Finder<Long, StatDayRegionOverview> find = new Finder<>(StatDayRegionOverview.class);

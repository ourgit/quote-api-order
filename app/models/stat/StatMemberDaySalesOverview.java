 ...
 */
@Entity
@Table(name = "v1_stat_member_day")
public class StatMemberDaySalesOverview extends Model {
    ...
    public static Finder<Long, StatMemberDaySalesOverview> find = new Finder<>(StatMemberDaySalesOverview.class);

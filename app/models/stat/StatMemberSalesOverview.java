 ...
 */
@Entity
@Table(name = "v1_stat_member_total")
public class StatMemberSalesOverview extends Model {
    ...
    public static Finder<Long, StatMemberSalesOverview> find = new Finder<>(StatMemberSalesOverview.class);
